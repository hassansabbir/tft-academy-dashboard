...
const AdminSquadDetails = () => {
  ...
  if (!squad) {
    return <div className="flex items-center justify-center h-full">Squad not found</div>;
  }
        ...
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 bg-white border border-gray-200 px-3 py-1 rounded-full shadow-sm">
              ...
              <span className="text-[12px] font-bold text-gray-900">{squad?.ageGroupId?.name || "N/A"}</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 mt-3 text-[13px]">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-gray-900 font-bold">{squad?.trainingDays?.join(" / ") || "N/A"}</span>
            </div>
            <div className="flex items-center gap-1.5">
